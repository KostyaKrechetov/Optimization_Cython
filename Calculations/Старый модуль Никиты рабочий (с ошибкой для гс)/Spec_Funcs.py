from math import factorial, sin, log, pi, sqrt, atan, tan, exp
...
def L_m(u , sin2a ,sum_number = 100):
    ...
    #Dim sina, cosa, ctga2, theta, integral, signum, k
...
def IK01A(x):
    ...
    if (x <= 9):
        ...
        for k in range(1,51):
           ...
           r = 0.25 * r / (k * k) * x2
           BK0 += r * (W0 + ct)
#           if (abs((BK0 - WW) / BK0) < 0.000000000000001): 
#               break
#           WW = BK0
        BK0 = BK0 + ct
    else:
